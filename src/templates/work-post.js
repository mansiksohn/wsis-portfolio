...
const BlogPostTemplate = (props) => {
  ...
  const nextLinkStatus = pageContext?.next ? pageContext?.next?.frontmatter?.templateKey === 'work-post' ? true : false : false
  const previousLinkStatus = pageContext?.previous ? pageContext?.previous?.frontmatter?.templateKey === 'work-post' ? true : false : false
